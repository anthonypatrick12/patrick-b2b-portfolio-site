...
export const metadata: Metadata = {
  ...
  description: "SDR-as-a-Service by Patrick — B2B Lead Generation",
};
    ...
    <main className="pt-28 pb-20">
      <div className="container">
        ...
        <p className="mt-4 text-white/70 max-w-3xl">
          Dedicated SDRs managed by us and integrated with your CRM. We own playbooks, cadences, reporting, and weekly
          reviews to deliver predictable meetings.
        </p>
