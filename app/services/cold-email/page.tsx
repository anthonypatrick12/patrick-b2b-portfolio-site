...
export const metadata: Metadata = {
  ...
  description: "Cold Email Campaigns service by Patrick — B2B Lead Generation",
};
    ...
    <main className="pt-28 pb-20">
      <div className="container">
        <nav className="text-white/60 text-sm mb-6">
          <Link href="/">Home</Link> / <Link href="/services">Services</Link> / <span className="text-white">Cold Email Campaigns</span>
        </nav>
        <h1 className="text-3xl md:text-5xl font-semibold">Cold Email Campaigns</h1>
        <p className="mt-4 text-white/70 max-w-3xl">Deliverability-first cold email with rigorous testing and personalization, from domains and warm-up to performance dashboards.</p>
