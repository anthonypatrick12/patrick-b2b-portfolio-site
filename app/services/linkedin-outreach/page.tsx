...
export const metadata: Metadata = {
  ...
  description: "LinkedIn Outreach service by Patrick — B2B Lead Generation",
};
    ...
    <main className="pt-28 pb-20">
      <div className="container">
        <nav className="text-white/60 text-sm mb-6">
          <Link href="/">Home</Link> / <Link href="/services">Services</Link> / <span className="text-white">LinkedIn Outreach</span>
        </nav>
        <h1 className="text-3xl md:text-5xl font-semibold">LinkedIn Outreach</h1>
        <p className="mt-4 text-white/70 max-w-3xl">Persona-led messaging and warm social touches that complement email. Smart sequencing increases replies without harming domain reputation.</p>
