    ...
    <main className="pt-28 pb-20">
      <div className="container">
        <nav className="text-white/60 text-sm mb-6">
          <Link href="/">Home</Link> / <Link href="/industries">Industries</Link> / <span className="text-white">Logistics</span>
        </nav>
        <h1 className="text-3xl md:text-5xl font-semibold">Logistics</h1>
        <p className="mt-4 text-white/70 max-w-3xl">Target operational leaders with clear trigger events (new warehouse/ERP). Multi-touch cadences and call follow-ups drive enterprise demos.</p>
